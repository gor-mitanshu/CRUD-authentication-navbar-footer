          ...
          <>
                              ...
                              { isLoggedIn ? (
                                   ...
                                   <li className="nav-item pe-3">
                                        <div className="ml-auto">
                                             <button className='btn btn-outline-light nav-btn' onClick={ handleShowLoginModal }>Login</button>
                                             <button className='btn btn-outline-light nav-btn ml-2' onClick={ handleShowSignupModal }>Signup</button>
                                        </div>
                                   </li>
                              ) }
                         </ul>
               ...
               <Modal show={ showSignupModal } handleCloseModal={ handleCloseSignupModal } title={ "Signup" } >
                    <form onSubmit={ handleSignup }>
                         ...
                         {/* Add additional fields for age, gender, hobbies, country, state, and city as needed */ }
