...
const initialProfileData = { firstName: "", lastName: "", email: "", age: "", gender: "", hobbies: "", country: "", state: "", city: "" };
const Dashboard = ({ userDetails }) => {
     ...
     return (
          <>
                                        ...
                                        <table className="table">
                                             ...
                                             <tbody>
                                                  { userDetails.profiles.map((data, index) => (
                                                       <tr key={ index }>
                                                            <td><img src={ data.profileImage } alt={ `${data.firstName} ${data.lastName}` } style={ { width: '50px', borderRadius: '50%' } } /></td>
               ...
               {/* Signup Modal */ }
               <Modal handleCloseModal={ handleCloseAddProfileModal } show={ showAddProfile } title={ "Add User" }>
                    <form onSubmit={ handleAddProfile }>
                         <div className="row">
                              <div className="col-lg-6">
                                   <div className="form-group">
                                        <label>First Name</label>
                                        <input type="text" className="form-control" placeholder="Enter first name" name="firstName" value={ profileUser.firstName } onChange={ handleProfileChange } />
                              ...
                              <div className="col-lg-6">
                                   <div className="form-group">
                                        ...
                                        <input type="text" className="form-control" placeholder="Enter last name" name="lastName" value={ profileUser.lastName } onChange={ handleProfileChange } />
                         ...
                         <div className="row">
                              <div className="col-lg-6">
                                   <div className="form-group">
                                        <label>Email</label>
                                        <input type="email" className="form-control" placeholder="Enter email" name="email" value={ profileUser.email } onChange={ handleProfileChange } />
                                   </div>
                              </div>
                              <div className="col-lg-6">
                                   <div className="form-group">
                                        <label>Age</label>
                                        <input type="number" className="form-control" placeholder="Enter age" name="age" value={ profileUser.age } onChange={ handleProfileChange } />
                                   </div>
                              </div>
                         </div>
                         ...
                         <div className="row">
                              ...
                              <div className="col-lg-6">
                                   <div className="form-group">
                                        <label>Hobbies</label>
                                        <input type="text" className="form-control" placeholder="Enter hobbies" name="hobbies" value={ profileUser.hobbies } onChange={ handleProfileChange } />
                                   </div>
                              </div>
                         </div>
                         ...
                         <div className="form-group">
                              <label>Country</label>
                              <select className="form-control" name="country" value={ profileUser.country } onChange={ handleCountryChange }>
                         ...
                         { profileUser.country && (
                              <div className="form-group">
                                   ...
                                   <select className="form-control" name="state" value={ profileUser.state } onChange={ handleStateChange }>
                                        ...
                                        { countries.find((c) => c.name === profileUser.country).states.map((state) => (
                         ...
                         { profileUser.state && (
                              <div className="form-group">
                                   ...
                                   <select className="form-control" name="city" value={ profileUser.city } onChange={ handleProfileChange }>
                                        ...
                                        { countries
                                             .find((c) => c.name === profileUser.country)
                                             .states.find((s) => s.name === profileUser.state)
                                             .cities.map((city) => (
